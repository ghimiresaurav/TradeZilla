...
// const SubCategoriesPath = () => useRoutes([
//   //Fashion
//   { path: "/fashion/mens-wear", element: <ProductList  title="Mens Wear"/>},
//   { path: "/fashion/womens-wear", element: <ProductList  title="Womens wear"/>},
//   { path: "/fashion/accessories", element: <ProductList  title=" Fashion Accessories"/>},
//   { path: "/fashion/shoes", element: <ProductList  title="Shoes"/>},
//   { path: "/fashion/bags", element: <ProductList  title="Bags"/>},


//   //Sports
//   { path: "/sports/sports-wear", element: <ProductList  title="Sports Wear"/> },
//   { path: "/sports/equipments", element: <ProductList  title="Sports Equipments"/> },
//   { path: "/sports/nutrition", element: <ProductList  title="Sports Nutrition"/> },
//   { path: "/sports/fitness", element: <ProductList  title="Fitness"/> },
//   { path: "/sports/accessories", element: <ProductList  title="Sports Accessories"/> },


//   //Electronics
//   { path: "/electronics/tablets-and-phones", element: <ProductList  title="Tablets and Phones"/> },
//   { path: "/electronics/computers", element: <ProductList  title="Computers"/> },
//   { path: "/electronics/cameras-and-accessories", element: <ProductList  title="Cameras and Accessories"/> },
//   { path: "/electronics/household-appliances", element: <ProductList  title="Household Appliances"/> },


//   //Households
//   { path: "/households/furnitures", element: <ProductList  title="Furnitures"/> },
//   { path: "/households/utensils", element: <ProductList  title="Utensils"/> },
//   { path: "/households/decorations", element: <ProductList  title="Decorations"/> },
//   { path: "/households/health-care", element: <ProductList  title="Health Care"/> },
//   { path: "/households/outdoors", element: <ProductList  title="Outdoors"/> },
  

//   //Music
//   { path: "/music/cd-and-cassettes", element: <ProductList  title="CD and Cassettes"/> },
//   { path: "/music/instruments", element: <ProductList  title="Instruments"/> },
//   { path: "/music/accessories", element: <ProductList  title="Music Accessories"/> },
//   { path: "/music/studio-items", element: <ProductList  title="Studio Items"/> },

//   //Groceries
//   { path: "/groceries/beverages", element: <ProductList  title="Beverages"/> },
//   { path: "/groceries/packaged-foods", element: <ProductList  title="Packaged Foods"/> },
//   { path: "/groceries/cooking-ingredients", element: <ProductList  title="Cooking Ingredients"/> },
//   { path: "/groceries/fresh-goods", element: <ProductList  title="Fresh Goods"/> },
//   { path: "/groceries/cleaning", element: <ProductList  title="Cleaning"/> },

//   //Books
//   { path: "/books/fiction", element: <ProductList  title="Fiction"/> },
//   { path: "/books/non-fiction", element: <ProductList  title="Non-Fiction"/> },
//   { path: "/books/literature", element: <ProductList  title="Literature"/> },
//   { path: "/books/biography", element: <ProductList  title="Biography"/> },
//   { path: "/books/education", element: <ProductList  title="Education"/> }  
// ]);
